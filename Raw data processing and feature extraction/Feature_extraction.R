...
#Load cultivars
load('Cultivars_NYUS.2.1_malus.Rdata')
cultivars_to_choose_from = gsub('Cultivar.','',cultivar_columns)
species_to_choose_from = c('vitis','malus')
...
#Third, your specie of interest for the prediction of freezing tolerance. Please copy and paste a cultivar from 'species_to_choose_from'
...
Weather_feature_generation = function(df,latitude = 43.00, cultivar = 'Gala',specie = 'malus'){
...
all_data_feature_extracted <- Weather_feature_generation(all_data,latitude = 43.0606, cultivar = 'Gala',specie = 'malus')
